...
public class UserProfileController : ControllerBase
{
    ...
    [HttpPut("me")]
    [Authorize]
    public async Task<IActionResult> UpdateMyProfile([FromBody] UpdateUserProfileRequestDto request)
    {
        var userId = User.FindFirstValue(ClaimTypes.NameIdentifier);
        var updated = await _userRepository.UpdateUserProfileAsync(userId, request);
